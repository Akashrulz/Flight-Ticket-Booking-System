...
class editflight extends Component {
  constructor(props) {
    ...
    this.upflight=this.upflight.bind(this);

  } 

  componentDidMount(){
    Flight_Service.getFlightById(this.state.fid).then((res)=> {
      let nflight=res.data;

      this.setState({
        source:nflight.source,
      destination:nflight.destination,
      airlineName:nflight.airlineName,
      date:nflight.date,
      fcode:nflight.fcode,
      fareFirst:nflight.fareFirst,
      fareEconomy:nflight.fareEconomy,
      startTime:nflight.startTime,
      endTime:nflight.endTime,
      seatFirst:nflight.seatFirst,
      seatEconomy:nflight.seatEconomy,
      notification:nflight.notification,
  ...
  upflight=(e)=>{
    ...
    console.log('nflight => ' + JSON.stringify(nflight));
      ...
      Flight_Service.updateFlight(nflight).then(res => {
            ...
            <div className="card col-md-6 offset-md-3 offset-md-3">
              ...
              <div className="card-body">
                <form>
                  ...
                  <button className="btn btn-success" onClick={this.upflight}>Update</button>
